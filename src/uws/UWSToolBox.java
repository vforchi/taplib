...
public class UWSToolBox {
	 ...
	 * 
	 * <p><i>Note:
	 * 	If the request attribute whose the name is stored inside {@link UWS#REQ_ATTRIBUTE_PARAMETERS} has been already set by the UWS library,
	 ...
	 * 	if there is a request attribute whose the name is stored inside {@link UWS#REQ_ATTRIBUTE_PARAMETERS}.
	 * </p>
	 * 
