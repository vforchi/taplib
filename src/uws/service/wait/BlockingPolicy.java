...
public interface BlockingPolicy {
	 ...
	 * 
	 * <p>
	 * 	Since a timeout or another special behavior may be chosen by this {@link BlockingPolicy}, the returned value may
	 ...
	 *                    	<i>&lt; 0 means indefinite, 0 means no wait and &gt0; means waiting the specified amount of seconds.</i>
	 ...
	 *            			(e.g. use the IP address) may be chosen by the {@link BlockingPolicy} implementation if required.</i>
	 * @param request		The request which is going to be blocked.
	 *               		<i>Should not be NULL.</i>
	 * 
	 * @return	The real duration (in seconds) that the UWS service must wait before returning a response to the given HTTP request.
	 *        	<i>&lt; 0 means indefinite, 0 means no wait and &gt0; means waiting the specified amount of seconds.</i>
	 *               
	 ...
	 *           				<i>Should not be NULL.</i>
	 * @param user				The user who originally asked for the blocking behavior.
	 *            				<i>If NULL, the request will be concerned as anonymous and a decision to identify the user
	 *            				(e.g. use the IP address) may be chosen by the {@link BlockingPolicy} implementation if required.</i>
