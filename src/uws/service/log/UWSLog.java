...
public interface UWSLog {
	 ...
	 * 	{@link #logHttp(LogLevel, HttpServletRequest, String, String, Throwable)} should be called.
	 ...
	 * 
	 * <p><i>Note:
	 * 	When a request is received, {@link #logHttp(LogLevel, HttpServletResponse, String, JobOwner, String, Throwable)} is called, and then,
