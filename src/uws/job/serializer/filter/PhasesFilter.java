...
/**
 * <p>Job filter based on the execution phase.
 * Only jobs that are in one of the execution phases listed in this filter are kept.</p>
 * 
 * <p>
 * 	The constructor of this filter requires exactly one execution phase.
 * 	But obviously more phases can be added to the list of accepted execution phases
 * 	by using the function {@link #add(ExecutionPhase)}.
 * </p> 
 * 
...
public final class PhasesFilter implements JobFilter {
	...
	/**
	 * <p>Build a {@link PhasesFilter} which will retain only jobs in the given execution phase.</p>
	 * 
	 * <p>More phases can be added into the list of accepted phases thanks to the function {@link #add(ExecutionPhase)}.</p>
	 * 
	...
	/**
	 * <p>Add the given phase in the list of accepted phases.</p>
	 * 
	 * <p><i>Note:
	 * 	The given phase is not added into the list if it is already inside.
	 * </i></p>
	 * 
	 * @param phase	An execution phase to add inside the list of accepted phases.
	 */
